...
export default function AddOpenAIAccountDialog({
  isOpen,
  onClose,
}: AddOpenAIAccountDialogProps) {
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-xs font-semibold text-gray-500 uppercase">
              {activeTab === "web"
                ? t("accounts.add.openai.web.email")
                : t("accounts.add.openai.api.email")}
            </label>
            <input
              type="text"
              ...
              placeholder={
                activeTab === "web"
                  ? t("accounts.add.openai.web.email_placeholder")
                  : t("accounts.add.openai.api.email_placeholder")
              }
              value={email}
            ...
            <>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  placeholder={t(
                    "accounts.add.openai.web.access_token_placeholder",
                  )}
                  value={accessToken}
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  placeholder={t(
                    "accounts.add.openai.web.session_token_placeholder",
                  )}
                  value={sessionToken}
